...
# 数据集加载函数，指明数据集的位置并统一处理为imgheight*imgwidth的大小，同时设置batch(一次加载多少张图片)
...
def train(epochs):
    ...
    begin_time = time()
    # 加载数据集
    train_ds, val_ds, class_names = data_load("E:/yang/newflower_photos/train",
                                              "E:/yang/newflower_photos/val", 224, 224, 16)
    print(class_names)
    # 加载模型
